...
|`POST`|`/clients/v1/shop-administrators/bulk`|Массовая загрузка администраторов магазинов|
|`POST`|`/clients/v1/products/bulk`|Массовая загрузка товаров (сувениров)|
|`POST`|`/clients/v1/product-tags/bulk`|Массовая загрузка тегов для товаров|
